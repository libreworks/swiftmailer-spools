 ...
 */
class Swift_PdoSpoolTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $object = new Swift_PdoSpool($this->createMock('MockPdo', null), 'foo', 'bar', 'message', 'sent');
    ...
    {
        new Swift_PdoSpool($this->createMock('MockPdo', null), 'foo', 'bar', 'message', "     ");
    }
    ...
    public function testQueueMessage()
    {
        ...
        $pdo = $this->createMock('MockPdo', array('prepare'));
        $stmt = $this->createMock('MockPdoStatement', array('bindValue', 'execute'));
    ...
    public function testFlushQueue()
    {
        ...
        $pdo = $this->createMock('MockPdo', array('prepare', 'query'));
        $stmta = $this->createMock('MockPdoStatement', array('fetchAll'));
        $stmtb = $this->createMock('MockPdoStatement', array('execute'));
        $stmtc = $this->createMock('MockPdoStatement', array('execute'));
        $pdo->expects($this->once())
            ->method('query')
